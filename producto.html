      ...
      <div class="row">
        <div class="col-md-3">
          <div class="card"> <img class="card-img-top" src="https://static.pingendo.com/cover-moon.svg" alt="Card image cap">
            <div class="card-body">
              <h4 class="card-title">Num Producto : 18189</h4>
            ...
            <div class="card-body p-4">
              ...
              <a class="btn btn-primary mt-3 mr-1" href="#">Comprar</a><a class="btn btn-primary ml-auto mt-3" href="#" contenteditable="true">Regresar</a>
            </div>
          </div>
        </div>
        <div class="col-md-6">
          ...
          <p class="">Paragraph. Then, my friend, when darkness overspreads my eyes, and heaven and earth seem to dwell in my soul and absorb its power, like the form of a beloved mistress, then I often think with longing.</p>
          <h2 class="">A quien va dirigido? </h2>
          <p class="">Paragraph. Then, my friend, when darkness overspreads my eyes, and heaven and earth seem to dwell in my soul and absorb its power, like the form of a beloved mistress, then I often think with longing.</p>
          <h2 class="">A quien va dirigido? </h2>
          <p class="">Paragraph. Then, my friend, when darkness overspreads my eyes, and heaven and earth seem to dwell in my soul and absorb its power, like the form of a beloved mistress, then I often think with longing.</p>
          <h2 class="">A quien va dirigido? </h2>
