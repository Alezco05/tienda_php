    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6" style="">
          <h1 class="">Heading 1</h1><img class="card-img-bottom rounded-circle float-left w-50 m-3" src="https://static.pingendo.com/cover-bubble-dark.svg" alt="Card image cap" width="25%
10px">
